    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Crear Nueva Tarea (API)</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Formulario de Tarea</h3>
                            </div>
                            <div class="card-body">
                                <form id="create-task-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" required placeholder="Ingrese el título de la tarea">
                                    </div>

                                    <div class="form-group">
                                        <label for="description">Descripción</label>
                                        <textarea class="form-control" id="description" name="description" rows="4" placeholder="Ingrese la descripción de la tarea"></textarea>
                                    </div>
...
<script>
    document.getElementById('create-task-form').addEventListener('submit', async function(event) {
        ...
        saveButton.disabled = true; // Deshabilitar botón
        saveButton.innerHTML = '<i class="fas fa-spinner fa-spin"></i> Guardando...';
        errorContainer.style.display = 'none';
        errorContainer.innerHTML = '';

        try {
            const response = await fetch('{{ route('api.tasks.store') }}', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                // Si todo salió bien, redirige al index (de la API)
            ...
            errorContainer.innerHTML = 'Error de red al intentar crear la tarea.';
            errorContainer.style.display = 'block';
        } finally {
            saveButton.disabled = false; // Rehabilitar botón
            saveButton.innerHTML = '<i class="fas fa-save"></i> Guardar Tarea';
        }
    });
</script>
</body>
